...
//! it boots, prints the boot image (the process table MINIX would load
//! into memory at this point), and exercises the IPC primitives with a
//! self-test message exchange. There is no scheduler, no user-mode
//! processes, and no MMU-based address-space isolation yet — see
